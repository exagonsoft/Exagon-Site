...
import IconAnimated from "../../reusable/AnimatedBackground/IconAnimated";
import Typer from "../../reusable/EXTyper/Typer";
      ...
      <div className="herosection relative overflow-hidden">
        <div className="herosection-content relative z-20 bg-grey-darken  bg-opacity-20">
            ...
            <div className="container relative mx-auto">
              <div className="flex min-h-screen w-full items-center justify-center">
                <div className="herosection-content w-full py-20 text-center md:w-3/4">
                  ...
                  <p className="lead  mb-0 block Welcome-Wrappwer">
                    I am a full stack software developer. I can provide clean
                    code and pixel perfect design. I also make website more
                    &amp; more interactive with web animations.
                  </p>
                  <div className="herosection-socialicons mt-7 text-center Welcome-Wrappwer">
                    <ul className="mb-0 inline-flex list-none flex-wrap gap-3 pl-0 sm:gap-4">
                      <li className="inline-block align-middle">
                        ...
                        >
                          ...
                          <span className="ObjectsHoverColor TextHoverColor back absolute left-0 top-0 flex h-full w-full translate-y-full items-center justify-center rounded bg-primary text-grey transition-all duration-500 group-hover:translate-y-0">
                            <svg
                              stroke="currentColor"
                              fill="currentColor"
                              strokeWidth="0"
              ...
              <div className="herosection-bottom absolute left-0 top-auto bottom-10 w-full justify-between text-center Welcome-Wrapper">
                <a className="cursor-pointer text-xs font-medium uppercase tracking-widest transition-all LinkText">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
